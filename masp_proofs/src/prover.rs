...
use crate::{default_params_folder, MASP_OUTPUT_NAME, MASP_SPEND_NAME};
...
impl LocalTxProver {
    ...
    pub fn from_bytes(spend_param_bytes: &[u8], output_param_bytes: &[u8]) -> Self {
        let (spend_params, spend_vk, output_params, _) =
            parse_parameters(spend_param_bytes, output_param_bytes);

...
mod test {
    ...
    fn test_pedersen_hash_external_test_vectors() {
        ...
        let expected_xs = [
            "31967239528412679088054297099244366416510721825238343120431579061440261913471",
            "33774989237890166973688854068053131225838447287039758661615743968407659537826",
        ];
        let expected_ys = [
            "38426531321209856869202228592007109802874565696183382248773995557147770824622",
            "42540177353217913814840292356856314767459220993291653961712364312775715276997",
        ];
